...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['create_order'])) {
    ...
    try {
        ...
        $stmt = $conn->prepare("INSERT INTO orders (table_id, customer_id, waiter_id, status, total_amount) VALUES (?, ?, ?, 'moi', 0)");
        $stmt->bind_param('iii', $table_id, $customer_id, $waiter_id);
