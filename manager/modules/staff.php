                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    ...
                                    <button class="btn-action btn-schedule" onclick="openScheduleModal(<?= $staff['user_id'] ?>, '<?= e($staff['full_name']) ?>')">
                                        <i class="fas fa-calendar-alt"></i> Phân ca
                                    </button>
                                    <button class="btn-action btn-edit" onclick="openEditStaffModal(<?= $staff['user_id'] ?>)">
                                        <i class="fas fa-edit"></i> Sửa
                                    </button>
                                    <button class="btn-action btn-delete" onclick="confirmDeleteStaff(<?= $staff['user_id'] ?>, '<?= e($staff['full_name']) ?>')">
...
(function() {
    ...
    async function deleteStaff(userId) {
        try {
            ...
            if (data.success) {
                if (typeof showToast === 'function') {
                    showToast(data.message || 'Xóa nhân viên thành công');
                }
                reloadStaffList();
            } else {
                alert('Lỗi: ' + data.message);
